...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="announcement-area">
			<?php
			$announcement_area = get_field('announcement_area');
			echo $announcement_area;?>
			<?php $announcement_link = get_field('announcement_link');?>
			<?php if($announcement_link):?>
				<a href="<?php echo $announcement_link['url'];?>" target="<?php echo $announcement_link['target'];?>"> <?php echo $announcement_link['title'];?></a>
			<?php endif;?>
		</div>
